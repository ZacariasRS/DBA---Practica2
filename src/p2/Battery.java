 ...
 * 
 * Agente para recibir el estado de la batería del servidor.
 */
public class Battery extends SingleAgent {

	private JSONObject data;
	private boolean state;
	
	public Battery(AgentID aid) throws Exception {
		super(aid);
		data = null;
		state = false;
	}
			...
			try {
				...
				if (sender.equals(RescueBots.nBot)) {
					if (state) {
						...
						outMsg.put("error", "no battery data");
					}
